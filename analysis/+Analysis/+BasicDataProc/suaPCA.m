...
switch pcaRun
    case 1
        ...
        if plt3d
            ...
            plt.PCAcolorplt(pc1, pc2, 'data3', pc3, 'colorChoice', {'#58126A', '#F6B2E1'}, 'eventIdx', eventIdx, 'eventLbl', eventLbl, 'titlePCA', centerDataOn{2});

            pc1 = PCdata.PCxTimeI(:,1);
            pc2 = PCdata.PCxTimeI(:,2);
            pc3 = PCdata.PCxTimeI(:,3);
            plt.PCAcolorplt(pc1, pc2, 'data3', pc3,'colorChoice', {'#07A3B2', '#D9ECC7'}, 'newFig', false, 'eventIdx', eventIdx, 'eventLbl', eventLbl);
            
            colorTempTest = {'#F6B2E1', '#D9ECC7'}; %dark to light red
    ...
    case 2 %=
        ...
        if plt3d
            ...
            plt.PCAcolorplt(pc1, pc2, 'data3', pc3, 'colorChoice',...
                {'#395886', '#B1C9EF'}, 'eventIdx', eventIdx, 'eventLbl', eventLbl, 'dataLbl', 'Response 1', 'titlePCA', titlePCAtemp);
