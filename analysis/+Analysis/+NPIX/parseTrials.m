function [spkITI,spkStimOn,spkResp] = parseTrials(unitSpikesCl,taskData)
...
for jj = 1:length(unitSpikesCl) 
    ...
    for ii = 1:length(taskData.Trial)-1
        ...
        if ~isempty(tempSpikeTimesConverted)
            tempSpikeTimesConverted(tempSpikeTimesConverted == 0) = 1;
            tempSpikeTimesConverted(tempSpikeTimesConverted >= preStim+postStim) = preStim+postStim;
        ...
        if ~isempty(tempSpikeTimesConverted)
            tempSpikeTimesConverted(tempSpikeTimesConverted == 0) = 1;
            tempSpikeTimesConverted(tempSpikeTimesConverted >= preResp+postResp) = preResp+postResp;
