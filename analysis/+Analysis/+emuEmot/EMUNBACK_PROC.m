...
% started. Also good for MW16 where the timestamps are all 255
...
if sessionName == 'MW_16' %for the unique case of MW_16
    imageOn = beh_timestampsEm;
...
%THIS IS WHERE I NEED TO GET THE TTL WHICH COMES FROM THE HEX CODE WHICH
%MARKS THE BEHAVIORAL RESPONSE IN THE NWB CODE. ONE THING IS SEEMS TO BE
%TOO MANY. SHOULD BE 54 TRIALS BASED ON THE RESPONSE
