...
mnPF1 = mean(peakfSp,1);
mnPF1 = normalize(mnPF1,2);
mnPFt1 = squeeze(mean(mnPF1,3));
sePFt1 = std(mnPF1, [], 3) / sqrt(size(mnPF1,3));
peakfSp2 = data2spectro(freqRowIlow-1+mxViR2-2:freqRowIlow-1+mxViR2+2,:,:);
mnPF2 = mean(peakfSp2,1);
mnPF2 = normalize(mnPF2,2);
mnPFt2 = squeeze(mean(mnPF2,3));
sePFt2 = std(mnPF2, [], 3) / sqrt(size(mnPF2,3));
H1 = shadedErrorBar(TT,mnPFt1,sePFt1*2,'lineprops', {'-b'});
hold on
H2 = shadedErrorBar(TT,mnPFt2,sePFt2*2,'lineprops', {'-r'});
legend([H1.mainLine H2.mainLine], {'Emt', 'IdT'})

[mean_sd, thresh_binary] = stats.shuffle_stats2d(Data1FreqPeakBPsSm, Data2FreqPeakBPsSm, 'xshuffles', 1000, 'plt', true, 'tt', tt , 'ff', ff);


figure
plot(tt, mean(Data1FreqPeakBPs))
hold on
plot(tt, mean(Data1FreqPeakBPsSm))

figure
imagesc(Data1MeanNorm); axis xy;


figure
pspectrum(Data1FreqPeakBP(1,:), fs, 'spectrogram', 'FrequencyLimits', [1 200])
...
xx=testDH{1}(:,:,1);
hgMHil = mean(xx(25:50,:));

[xxx, xi]= max(IdMeanNorm,[],'all');
...
tempClassicBandFFNS=filtfilt(lpFilt, tempClassicBandNS);
negTempNS=find(tempClassicBandFFNS<0);
tempClassicBandFFNS(negTempNS)=tempClassicBandFFNS(negTempNS)*-1;
tempCBCNS(:,ii,:)=tempClassicBandFFNS; %data x band x channel
end

%toy data for Nick 
%MW18 channel 161160

filterNum = fields(identityTaskLFP.byidentity.ch3938.image.bandPassed);

for ii = 1:length(filterNum)
    clear temp1 temp2 temp3
temp1 = identityTaskLFP.byidentity.ch3938.image.bandPassed.(filterNum{ii}){1};
temp2 = identityTaskLFP.byidentity.ch3938.image.bandPassed.(filterNum{ii}){2};
temp3 = identityTaskLFP.byidentity.ch3938.image.bandPassed.(filterNum{ii}){3};
MW18ch3938.identity.bandpassed.(filterNum{ii}) = cat(1,temp1, temp2, temp3);
end
clear temp1 temp2 temp3
temp1 = identityTaskLFP.byidentity.ch3938.image.Hilbert.Power{1};
temp2 = identityTaskLFP.byidentity.ch3938.image.Hilbert.Power{2};
temp3 = identityTaskLFP.byidentity.ch3938.image.Hilbert.Power{3};
MW18ch3938.identity.Hilbert.Power = cat(3,temp1, temp2, temp3);
clear temp1 temp2 temp3
temp1 = identityTaskLFP.byidentity.ch3938.image.Hilbert.Angle{1};
temp2 = identityTaskLFP.byidentity.ch3938.image.Hilbert.Angle{2};
temp3 = identityTaskLFP.byidentity.ch3938.image.Hilbert.Angle{3};
MW18ch3938.identity.Hilbert.Angle = cat(3,temp1, temp2, temp3);
clear temp1 temp2 temp3
temp1 = identityTaskLFP.byidentity.ch3938.image.specD{1};
temp2 = identityTaskLFP.byidentity.ch3938.image.specD{2};
temp3 = identityTaskLFP.byidentity.ch3938.image.specD{3};
MW18ch3938.identity.specD = cat(3,temp1, temp2, temp3);


for ii = 1:length(filterNum)
    clear temp1 temp2 temp3
temp1 = emotionTaskLFP.byemotion.ch3938.image.bandPassed.(filterNum{ii}){1};
temp2 = emotionTaskLFP.byemotion.ch3938.image.bandPassed.(filterNum{ii}){2};
temp3 = emotionTaskLFP.byemotion.ch3938.image.bandPassed.(filterNum{ii}){3};
MW18ch3938.emotion.bandpassed.(filterNum{ii}) = cat(1,temp1, temp2, temp3);
end
clear temp1 temp2 temp3
temp1 = emotionTaskLFP.byemotion.ch3938.image.Hilbert.Power{1};
temp2 = emotionTaskLFP.byemotion.ch3938.image.Hilbert.Power{2};
temp3 = emotionTaskLFP.byemotion.ch3938.image.Hilbert.Power{3};
MW18ch3938.emotion.Hilbert.Power = cat(3,temp1, temp2, temp3);
clear temp1 temp2 temp3
temp1 = emotionTaskLFP.byemotion.ch3938.image.Hilbert.Angle{1};
temp2 = emotionTaskLFP.byemotion.ch3938.image.Hilbert.Angle{2};
temp3 = emotionTaskLFP.byemotion.ch3938.image.Hilbert.Angle{3};
MW18ch3938.emotion.Hilbert.Angle = cat(3,temp1, temp2, temp3);
clear temp1 temp2 temp3
temp1 = emotionTaskLFP.byemotion.ch3938.image.specD{1};
temp2 = emotionTaskLFP.byemotion.ch3938.image.specD{2};
temp3 = emotionTaskLFP.byemotion.ch3938.image.specD{3};
MW18ch3938.emotion.specD = cat(3,temp1, temp2, temp3);

MW18ch3938.specDTime = identityTaskLFP.tPlotImage;
MW18ch3938.specDFreq = identityTaskLFP.freq;
MW18ch3938.hilbertTime = identityTaskLFP.tPlotImageBandPass;
MW18ch3938.hilbertFreq = identityTaskLFP.freqHilbert;
MW18ch3938.bandpassedTime = identityTaskLFP.tPlotImageBandPass;
...
figure
plot(rms(tempClassicBandNS))
hold on
plot(tempClassicBandFFNS)
