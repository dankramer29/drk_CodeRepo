...
%     ResponseTimeEm = [];
    ...
    idx2 = 1;
    %     for nn = 5:7 %runs through each emotion
    %              T1 = [];
    %         pkIndex = [];
    %         ChannelNumber = [];
    %         TrialType = [];
    ...
    %                     end
    %                     T1 = table(PatientName, RecordingLocation, ChannelNumber, TrialType, TrialNumber, TimeMinMax, FreqMinMax, ImageType, ClusterCenter,...
    %                         TstatCluster, ByTrialCentroid, ByTrialArea, ByTrialBoundingBoxTimeRange, ByTrialBoundingBoxFreqRange, MaxValue, TimeofMax,...
    %                         CorrectResponse, ResponseTime, SecondTrial);
    %                 end
    %             end
