...
comparedToSubtractionITI = 1;  itiOptions = 3;
if comparedToSubtractionITI == 1
    ...
    for ii = 1:length(chInterest)
        ...
        itiDataFull = cat(3, itiDataId, itiDataEm); %create the full iti data set from both.
        [nback.(chName{ii}).allIdentities.identityTaskMean, ~,...
            ...
            nback.(chName{ii}).allIdentities.identityTasksigclust,...
                ...
                nback.(chName{ii}).allIdentities.identityTaskAllClusterNumbers] = stats.cluster_permutation_Subtraction_Ttest_gpu3d(dataEmotionTaskAllIdentities, itiDataEm, dataIdentityTaskAllIdentities, itiDataId,...
                'xshuffles', xshuffles, 'tt', identityTaskLFP.tPlotImage, 'ff', identityTaskLFP.freq, 'flipData', 0 );
