...
%                 nback.(chName{ii}).(idName{jj}).identityTaskcentroid] = stats.cluster_permutation_Ttest_gpu3d( dataIdentityTask, itiDataId, 'xshuffles', xshuffles);
%             
            ...
            [nback.(chName{ii}).(idName{jj}).emotionTaskMean, ~,...
                ...
                nback.(chName{ii}).(idName{jj}).emotionTaskcentroid] = stats.cluster_permutation_Ttest_gpu3d( dataEmotionTask, itiDataEm, 'xshuffles', xshuffles);
        ...
        [nback.(chName{ii}).allIdentities.identityTaskMean, ~,...
            ...
            nback.(chName{ii}).allIdentities.identityTasksigclust,...
                nback.(chName{ii}).allIdentities.identityTaskcentroid] = stats.cluster_permutation_Ttest_gpu3d( dataIdentityTaskAllIdentities, itiDataId, 'xshuffles', xshuffles);
        [nback.(chName{ii}).allIdentities.emotionTaskMean, ~,...
            ...
            nback.(chName{ii}).allIdentities.emotionTasksigclust,...
                nback.(chName{ii}).allIdentities.emotionTaskcentroid] = stats.cluster_permutation_Ttest_gpu3d( dataEmotionTaskAllIdentities, itiDataEm, 'xshuffles', xshuffles);
        ...
        for jj = 1:numEmotions %goes through each emotion for both tasks
            ...
            [nback.(chName{ii}).(emotName{jj}).identityTaskMean, ~,...
                ...
                nback.(chName{ii}).(emotName{jj}).identityTaskcentroid] = stats.cluster_permutation_Ttest_gpu3d( dataIdentityTask, itiDataId, 'xshuffles', xshuffles);
            [nback.(chName{ii}).(emotName{jj}).emotionTaskMean, ~,...
                ...
                nback.(chName{ii}).(emotName{jj}).emotionTaskcentroid] = stats.cluster_permutation_Ttest_gpu3d( dataEmotionTask, itiDataEm, 'xshuffles', xshuffles);
        ...
        [nback.(chName{ii}).allEmotions.identityTaskMean, ~,...
            ...
            nback.(chName{ii}).allEmotions.identityTasksigclust,...
                nback.(chName{ii}).allEmotions.identityTaskcentroid] = stats.cluster_permutation_Ttest_gpu3d( dataIdentityTaskAllEmotions, itiDataId, 'xshuffles', xshuffles);
        [nback.(chName{ii}).allEmotions.emotionTaskMean, ~,...
            ...
            nback.(chName{ii}).allEmotions.emotionTasksigclust,...
                nback.(chName{ii}).allEmotions.emotionTaskcentroid] = stats.cluster_permutation_Ttest_gpu3d( dataEmotionTaskAllEmotions, itiDataEm, 'xshuffles', xshuffles);
