...
[varargin, chRemove] = util.argkeyval('chRemove',varargin, []); %if you need to remove a whole channel
...
ch = Tch.flaggedChannel;
variant = Tch.flaggedVariant;
trial = Tch.flaggedTrials;
