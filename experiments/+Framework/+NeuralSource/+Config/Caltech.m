function Caltech(ns,varargin)

% process user inputs
[varargin,lfp] = util.argflag('lfp',varargin,false);
[varargin,spike,~,found] = util.argflag('spike',varargin,false);
if ~found,spike=true;end
[varargin,record] = util.argflag('record',varargin,false);
util.argempty(varargin);

% window size in framework cycles for spike and lfp
ns.dtMultipleEvent = 1.5;
