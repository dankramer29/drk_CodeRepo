function [nextX,nextIdealX]=PredictContinuous2(obj,varargin)
...
[nextIdealX,nextIdealForce]=obj.idealAgent.computeNextStep([curX;0],assistGoal);
...
if obj.isTrained
    ...
    if isfield(obj.frameworkParams,'useSingleUnit') && obj.frameworkParams.useSingleUnit==1;
        ...
        [Vel,iV]=estimateVel2(obj,curZ,curX);
    end
...
nextX=integrateWithConstraints2(obj,[curX;0],Vel);

intXNeural=[curX;0];
intXNeural(2:2:end)=VelNeural;
% neuralX=obj.runtimeParams.pIntegrator*intXNeural;
neuralX=integrateWithConstraints2(obj,[curX;0],VelNeural);


nextX=applyConstraints(obj,nextX(1:2));
neuralX=applyConstraints(obj,neuralX(1:2));
