function Parameters_SepCues_SepNums_OpFirst(obj)
% This parameter set evaluates numbers and arithmetic operators
% sequentially, with arithmetic operator being shown first.
%
...
obj.user.balance = {'cuemodality','nummodality'}'; % 'response', 'answer'
...
obj.phaseDefinitions{3} = {@Task.Common.PhaseDelay,...
    ...
    'durationTimeout',2.0};
obj.phaseDefinitions{4} = {@Task.Arithmetic.PhaseCueNumber1,...
    'Name','CueNumber1',...
    'durationTimeout',1.0};
obj.phaseDefinitions{5} = {@Task.Common.PhaseDelay,...
    ...
    'drawFixationPoint',false,...
    'durationTimeout',2.0};
obj.phaseDefinitions{6} = {@Task.Arithmetic.PhaseCueNumber2,...
    'Name','CueNumber2',...
    'durationTimeout',1.0};
