function DefaultSettings_PreDelay(obj)
...
obj.phaseDefinitions{3} = {@Task.DelayedReachGNG.PhaseCueGNG,...
    'Name','Cue',...
    'durationTimeout',1.0};
obj.phaseDefinitions{4} = {@Task.DelayedReachGNG.PhaseDelay,...
    ...
    'drawFixationPoint',true,...
    'durationTimeout',@(x)2+2*rand};
obj.phaseDefinitions{5} = {@Task.DelayedReachGNG.PhaseRespondGNG_PreDelay,...
    'Name','RespondGNG',...
    'durationTimeout',4.0};
