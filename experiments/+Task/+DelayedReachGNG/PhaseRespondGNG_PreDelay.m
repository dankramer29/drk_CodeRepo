classdef PhaseRespondGNG_PreDelay < handle & Experiment2.PhaseInterface & util.Structable & util.StructableHierarchy
    ...
    methods
        function this = PhaseRespondGNG_PreDelay(varargin)
