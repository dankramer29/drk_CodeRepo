classdef PhaseAction < handle & Experiment2.PhaseInterface & util.Structable & util.StructableHierarchy
    ...
    methods
        function this = PhaseAction(varargin)
...
%        end % END function StartFcn
        ...
        function PreDrawFcn(this,evt,hTask,varargin)
            if this.drawFixationPoint
                ...
                diam = hTask.hDisplayClient.normScale2Client(0.15);
                hTask.hDisplayClient.drawOval(pos,diam,[0 150 0]);
