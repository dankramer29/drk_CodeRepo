...
obj.user.bisectorPositions = [-1 -0.5 0.5 1]; % bisector positions, in units of symbols distance from the center point
...
Task.LineBisection.DefaultSettings_Fast(obj);