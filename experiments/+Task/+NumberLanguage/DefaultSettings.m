...
obj.phaseDefinitions{1} = {@Task.Common.PhaseITI,...
    ...
    'durationTimeout',1.5};
obj.phaseDefinitions{2} = {@Task.NumberLanguage.PhasePresentNumber,...
    'Name','ShowSymbols',...
    'durationTimeout',1.0};
obj.phaseDefinitions{3} = {@Task.Common.PhaseDelay,...
    ...
    'drawFixationPoint',true,...
    'durationTimeout',2.0};
obj.phaseDefinitions{4} = {@Task.NumberLanguage.PhaseIndicateResponse,...
    'Name','IndicateCatch',...
    'durationTimeout',0.5};
obj.phaseDefinitions{5} = {@Task.NumberLanguage.PhaseRespond,...
    'Name','Respond',...
