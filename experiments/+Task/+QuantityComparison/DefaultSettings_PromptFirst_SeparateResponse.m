function DefaultSettings_PromptFirst_SeparateResponse(obj)
...
obj.phaseDefinitions{1} = {@Task.Common.PhaseITI,...
    'Name','ITI',...
    'durationTimeout',2.0};
obj.phaseDefinitions{2} = {@Task.QuantityComparison.PhaseShowPrompt,...
    'Name','ShowPrompt',...
    'durationTimeout',1.0};
obj.phaseDefinitions{3} = {@Task.Common.PhaseDelay,...
    ...
    'durationTimeout',1.0};
obj.phaseDefinitions{4} = {@Task.QuantityComparison.PhaseShowSymbols_NoResponse,...
    'Name','ShowSymbols',...
    'drawFixationPoint',true,...
    'durationTimeout',1.0};
