function Parameters_OvalFrameSize_PromptFirst_SepResp(obj)
...
obj.user.symbolShapeType = 'ovalframe'; % type of shape to draw
obj.user.symbolOtherArguments = {5}; % pen width
