classdef PhaseShowSymbols < handle & Experiment2.PhaseInterface & util.Structable & util.StructableHierarchy
    ...
    methods
        function this = PhaseShowSymbols(varargin)
            this = this@Experiment2.PhaseInterface(varargin{:});
        end % END function PhaseShowSymbols
