function DefaultSettings_AnsFirst_SeparateResponse(obj)
...
% trial data
obj.trialDataConstructor = @Task.SpatialAttentionArithmetic.TrialData;

% keyboard
obj.keys.response = {{},{'LeftArrow','RightArrow','UpArrow','DownArrow'}};

% trial params
obj.trialParamsFcn = @Task.SpatialAttentionArithmetic.createTrialParams;

% title screen
pidx=1;
obj.prefaceDefinitions{pidx} = {@Task.Common.PrefaceTitle,...
    'Name','Title',...
    'titleString','Spatial Attention Arithmetic Task',...
...
obj.phaseDefinitions{1} = {@Task.Common.PhaseITI,...
    'Name','ITI',...
    'durationTimeout',2.0};
obj.phaseDefinitions{2} = {@Task.SpatialAttentionArithmetic.PhaseShowAnswers_NoResponse,...
    'Name','ShowAnswers',...
...
obj.phaseDefinitions{3} = {@Task.Common.PhaseDelay,...
    ...
    'drawFixationPoint',true,...
    'durationTimeout',1.0};
obj.phaseDefinitions{4} = {@Task.SpatialAttentionArithmetic.PhaseShowOperation,...
    'Name','ShowOperation',...
    'durationTimeout',1.0};
obj.phaseDefinitions{5} = {@Task.Common.PhaseDelay,...
    ...
    'drawFixationPoint',true,...
    'durationTimeout',1.0};
obj.phaseDefinitions{6} = {@Task.SpatialAttentionArithmetic.PhaseRespond,...
    'Name','Respond',...
