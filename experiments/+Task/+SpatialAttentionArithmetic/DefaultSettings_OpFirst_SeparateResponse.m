function DefaultSettings_OpFirst_SeparateResponse(obj)
...
obj.phaseDefinitions{1} = {@Task.Common.PhaseITI,...
    'Name','ITI',...
    'durationTimeout',2.0};
obj.phaseDefinitions{2} = {@Task.SpatialAttentionArithmetic.PhaseShowOperation,...
    'Name','ShowOperation',...
    'durationTimeout',1.0};
obj.phaseDefinitions{3} = {@Task.Common.PhaseDelay,...
    ...
    'durationTimeout',1.0};
obj.phaseDefinitions{4} = {@Task.SpatialAttentionArithmetic.PhaseShowAnswers_NoResponse,...
    'Name','ShowAnswers',...
    'drawFixationPoint',true,...
    'durationTimeout',1.0};
