classdef TrialData < handle & Experiment2.TrialDataInterface & util.Structable & util.StructableHierarchy
    ...
    properties
        ...
        tr_perceptFelt % logical t/f indicating whether percept felt
        tr_perceptDescription % subject's description of the percept
        ...
        et_pause % to get the frame id for each 'space' keypresses
    ...
    methods
        ...
        function calculateSuccess(this,~)
            if strcmpi(this.tr_responseSymbol,'x')
                this.ex_success = nan;
            else
                this.ex_success = strcmpi(this.tr_responseSymbol,' ');
            end
