function DefaultSettings_FastResponse(obj)
...
% phases
% obj.phaseDefinitions{1} = {@Task.DirectReach.PhaseFixate,...
%     'Name','ITI',...
%     'drawFixationPoint',true,...
%     'durationTimeout',@(x)1.5+1*rand};
% obj.phaseDefinitions{2} = {@Task.Stroop.PhaseCueOnly,...
%     'Name','Cue',...
%     'durationTimeout',5};
% obj.phaseDefinitions{3} = {@Task.Stroop.PhaseRespond,...
%     'Name','Respond',...
%     'durationTimeout',5};
...
obj.phaseDefinitions{2} = {@Task.Stroop.PhaseCue,...
    'Name','Cue',...
    'durationTimeout',3};
obj.phaseDefinitions{3} = {@Task.Common.PhaseITI,...
    'Name','ITI',...
