classdef PrefaceInstructions04 < handle & Experiment2.PhaseInterface & util.Structable & util.StructableHierarchy
    ...
    methods
        function this = PrefaceInstructions04(varargin)
            this = this@Experiment2.PhaseInterface(varargin{:});
        end % END function PrefaceInstructions04
        
        function StartFcn(this,evt,hTask,varargin)
            hTask.expectInput({'prev','LeftArrow'},{'next','RightArrow'},{'skip','escape'});
            hTask.hSound.play('responseNumber');
        ...
        function PhaseFcn(this,evt,hTask,varargin)
            ...
            elseif ~isempty(prev)
                hTask.hPreface.advance('Instructions_03');
            elseif ~isempty(skip)
...
end % END classdef PrefaceInstructions04