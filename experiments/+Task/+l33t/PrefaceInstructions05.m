classdef PrefaceInstructions05 < handle & Experiment2.PhaseInterface & util.Structable & util.StructableHierarchy
    ...
    methods
        function this = PrefaceInstructions05(varargin)
            this = this@Experiment2.PhaseInterface(varargin{:});
        end % END function PrefaceInstructions05
        ...
        function PhaseFcn(this,evt,hTask,varargin)
            ...
            elseif ~isempty(prev)
                hTask.hPreface.advance('Instructions_04');
            elseif ~isempty(skip)
...
end % END classdef PrefaceInstructions05