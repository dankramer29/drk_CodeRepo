classdef PrefaceInstructions06 < handle & Experiment2.PhaseInterface & util.Structable & util.StructableHierarchy
    ...
    methods
        function this = PrefaceInstructions06(varargin)
            this = this@Experiment2.PhaseInterface(varargin{:});
        end % END function PrefaceInstructions06
        ...
        function PhaseFcn(this,evt,hTask,varargin)
            ...
            elseif ~isempty(prev)
                hTask.hPreface.advance('Instructions_05');
            elseif ~isempty(skip)
...
end % END classdef PrefaceInstructions06