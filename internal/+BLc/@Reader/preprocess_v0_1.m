...
for kk=1:length(idxDataSections)
    ...
    this.DataInfo(currDataSection).StartTime = this.OriginTime + seconds(this.DataInfo(currDataSection).Timestamp/this.SamplingRate);
