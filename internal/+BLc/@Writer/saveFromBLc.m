function files = saveFromBLc(this,varargin)
% SAVEFROMBLC Create a new BLc file from an existing BLc source
%
%   FILES = SAVEFROMBLC(THIS)
%   Use the source BLc object to provide properties to create one or more
%   new BLC files. Data must be provided as an input argument. The BLC file(s) will be created in the same directory,
%   and with the same basename (but with a zero-based
