...
data1=chronux.hlp.change_row_to_column(data1);
data2=chronux.hlp.change_row_to_column(data2);
...
N=chronux.hlp.check_consistency(data1,data2);
nfft=max(2^(nextpow2(N)+pad),N);
[f,findx]=chronux.hlp.getfgrid(Fs,nfft,fpass); 
tapers=chronux.hlp.dpsschk(tapers,N,Fs); % check tapers
J1=chronux.ct.mtfftc(data1,tapers,nfft,Fs);
J2=chronux.ct.mtfftc(data2,tapers,nfft,Fs);
