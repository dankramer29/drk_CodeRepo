...
[datafit,Amps,freqs,Fval,sig]=chronux.ct.fitlinesc(data,params,p,'n',f0);
datan=data-datafit;
...
if nargout==0 || strcmp(plt,'y'); 
   figure;
   [S1,f]=chronux.ct.mtspectrumc(detrend(data),params);
   ...
   [S2,f]=chronux.ct.mtspectrumc(detrend(datan),params);
