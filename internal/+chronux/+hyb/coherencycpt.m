...
J1=chronux.ct.mtfftc(data1,tapers,nfft,Fs); % fourier transform of continuous data
...
if nargout==10; 
  if fscorr==1; 
     [confC,phistd,Cerr]=chronux.hlp.coherr(C,J1,J2,err,trialave,[],Nsp2); 
  else
     [confC,phistd,Cerr]=chronux.hlp.coherr(C,J1,J2,err,trialave); 
  end;
elseif nargout==9;
  if fscorr==1; 
     [confC,phistd]=chronux.hlp.coherr(C,J1,J2,err,trialave,[],Nsp2); 
  else
