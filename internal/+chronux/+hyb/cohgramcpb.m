...
for n=1:nw;
   ...
   if nargout==11;
     [c,ph,s12,s1,s2,f,zsp,confc,phie,cerr]=chronux.hyb.coherencycpb(datawin1,datawin2,params,fscorr);
...
%      phierr(2,n,:,:)=squeeze(phie(2,:,:));
   ...
   elseif nargout==10;
     [c,ph,s12,s1,s2,f,zsp,confc,phie]=chronux.hyb.coherencycpb(datawin1,datawin2,params,fscorr);
%      phierr(1,n,:,:)=squeeze(phie(1,:,:));
%      phierr(2,n,:,:)=squeeze(phie(2,:,:));
     phistd(n,:,:)=phie;
   else
     [c,s12,s1,s2,ph,f,zsp]=chronux.hyb.coherencycpb(datawin1,datawin2,params,fscorr);
   end;
   C(n,:,:)=c;
   phi(n,:,:)=ph;
   S12(n,:,:)=s12;
