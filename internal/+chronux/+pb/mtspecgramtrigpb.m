...
data=chronux.pb.createdatamatpb(data,E,Fs,win); 
if nargout==5;[S,t,f,R,Serr]=chronux.pb.mtspecgrampb(data,movingwin,params,fscorr);
else [S,t,f,R]=chronux.pb.mtspecgrampb(data,movingwin,params,fscorr);end;
