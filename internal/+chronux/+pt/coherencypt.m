...
[J1,Msp1,Nsp1]=chronux.pt.mtfftpt(data1,tapers,nfft,t,f,findx);
[J2,Msp2,Nsp2]=chronux.pt.mtfftpt(data2,tapers,nfft,t,f,findx);
...
if nargout==10; 
    if fscorr==1; 
       [confC,phistd,Cerr]=chronux.hlp.coherr(C,J1,J2,err,trialave,Nsp1,Nsp2);
    else
       [confC,phistd,Cerr]=chronux.hlp.coherr(C,J1,J2,err,trialave);
    end;
elseif nargout==9;
    if fscorr==1; 
        [confC,phistd]=chronux.hlp.coherr(C,J1,J2,err,trialave,Nsp1,Nsp2);
    else
        [confC,phistd]=chronux.hlp.coherr(C,J1,J2,err,trialave);
    end;
end;
clear Msp1 Msp2
