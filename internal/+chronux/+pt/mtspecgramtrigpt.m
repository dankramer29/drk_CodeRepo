...
data=chronux.pt.createdatamatpt(data,E,win);
if nargout==5; 
    [S,t,f,R,Serr]=chronux.pt.mtspecgrampt(data,movingwin,params,fscorr);
else 
    [S,t,f,R]=chronux.pt.mtspecgrampt(data,movingwin,params,fscorr);
end;
