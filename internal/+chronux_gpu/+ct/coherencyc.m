function [C,phi,S12,S1,S2,f,confC,phistd,Cerr]=coherencyc(data1,data2,params,init,gpuflag)
...
data2=chronux_gpu.hlp.change_row_to_column(data2);
...
if ~isempty(init)
    ...
    N=chronux_gpu.hlp.check_consistency(data1,data2);
...
J2=chronux_gpu.ct.mtfftc(data2,tapers,nfft,Fs, true);
