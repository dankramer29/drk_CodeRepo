function [confC,phistd,Cerr]=coherr(C,J1,J2,err,trialave,numsp1,numsp2,gpuflag)
...
if nargin<6 || (nargin>=6 && isempty(numsp1)); numsp1flag=false; else numsp1flag=true; end;
if nargin<7 || (nargin>=7 && isempty(numsp2)); numsp2flag=false; else numsp2flag=true; end;
...
if errchk==1;
   totnum=nf*Ch;
   phistd=zeros(totnum,1,'gpuArray'); 
