function [tapers,eigs]=dpsschk(tapers,N,Fs,gpuflag,datatype)
...
if ~strcmpi(class(tapers),datatype)
    tapers=cast(tapers,datatype);
    eigs=cast(eigs,datatype);
end
if gpuflag
