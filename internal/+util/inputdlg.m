...
%  THIS FILE DOWNLOADED FROM MATHWORKS SUPPORT:
%  http://www.mathworks.com/matlabcentral/answers/96640-how-can-i-modify-the-inputdlg-function-to-make-the-enter-key-synonymous-with-the-ok-button
%
...
%%% Handle Input Args %%%
%%%%%%%%%%%%%%%%%%%%%%%%%
if nargin<1,Prompt='Input:';end
Prompt = util.ascell(Prompt);
NumQuest = numel(Prompt);

if nargin<2,Title=' ';end

if nargin<3,NumLines=1;end
