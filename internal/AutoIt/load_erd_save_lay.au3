...
If Not $myErdFile Then
   $myErdFile = "Z:\neural\incoming\unsorted\keck\JUNG~ FRANCESC_1f4ca8ed-9d98-4b28-8f97-b08618453a90\JUNG~ FRANCESC_1f4ca8ed-9d98-4b28-8f97-b08618453a90.erd"
EndIf
...
;~ 	_LogMessage($fcnstr & "Event file is " & $myEventFile & " in directory " & $myEventDir)
	...
	_ActivateWindow($ErdWindowTitle)
	sleep(100)
	ControlClick($ErdWindowTitle, "", "[CLASS:ToolbarWindow32; INSTANCE:1]", "left", 1, 35,20 )
	sleep(1000)
	MouseClick($MOUSE_CLICK_LEFT, 150, 80, 1)

	; left click to open tools
	ControlClick($ErdWindowTitle, "", "[CLASS:XTPToolBar; INSTANCE:2]", "left", 1, 40,590 )

	;open clip/export window
	MouseClick($MOUSE_CLICK_LEFT, 150, 685, 1)
	Sleep(1000)
