...
wordList = [wordList; headwords; wordsTested.mappedText];
wordList = unique(wordList);
save('/Users/frankwillett/Data/Derived/Handwriting/rnnDecoding/wordListForInference','wordList');

empErr = load('/Users/frankwillett/Data/Derived/Handwriting/rnnDecoding/confusionMatrix.mat');
...
for trialIdx = 1:size(rnnData.rnnText,1)
    ...
    for w=1:length(wordList)
        ...
        LOGPSEQ = hmmprob_frw(int32(wordStr)-96,A_hmm{w},B_hmm{w},startProb);
        emProb(w,1) = LOGPSEQ;
