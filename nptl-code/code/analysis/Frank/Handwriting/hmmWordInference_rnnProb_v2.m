...
%rnnData=load('/Users/frankwillett/Data/Derived/Handwriting/rnnDecoding/rnnDecoderOutputHugeNet.mat');
%rnnData=load('/Users/frankwillett/Data/Derived/Handwriting/rnnDecoding/rnnDecoderOutput_89.mat');
rnnData=load('/Users/frankwillett/Data/Derived/Handwriting/rnnDecoding/rnnDecoderOutput_907.mat');
...
%%
%find duplicates
isDup = zeros(length(rnnData.rnnText),1);
for x=1:length(isDup)
    isDup(x) = length(find(strcmp(wordsTested.mappedText, deblank(rnnData.trueText(x,:)))))>1;
end
