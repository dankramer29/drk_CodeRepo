...
plotVars = {bothAttenFactors, [allDat.dualToSingle1, allDat.dualToSingle2]};
plotVars_ci = {bothAttenFactors_ci, allDat.dualToSingle_ci};
...
yLabels = {'Dual/Single Ratio','cos(\theta)'};
yLimits = {[0 1.6],[0 1]};
