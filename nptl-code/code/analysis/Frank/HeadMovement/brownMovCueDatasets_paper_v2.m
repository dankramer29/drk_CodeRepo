...
%     end
    ...
    close all;
    save([outDirRoot sessionList{sessIdx} filesep 'eff_barData'],'cVar','cVar_proj', 'dPCA_out');
    ...
    for setIdx=1:14
        ...
        %dataMatrix = [nanmean(mov1Activity,3); nanmean(mov2Activity,3)];
        dataMatrix = [mov1Activity(:,:); mov2Activity(:,:)];
    ...
    close all;
    save([outDirRoot sessionList{sessIdx} filesep 'pair_barData'],'cVar','cVar_proj', 'dPCA_out');
