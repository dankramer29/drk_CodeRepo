...
excludeChannels = [];
sessionName = 't5.2018.01.08';
filterName = '008-blocks013_014-thresh-3.5-ch60-bin15ms-smooth25ms-delay0ms.mat';
...
%%
outDir = [paths.dataPath filesep 'Derived' filesep 'MovementSweep' filesep 'head_vs_bci_sess2'];
mkdir(outDir);
...
for plotCross = 1:2
    movTypeText = {'Head','OL BCI 1','CL BCI 1','OL BCI 2','CL BCI 2','CL BCI 3'};
    topN = 8;
    plotIdx = 1;
