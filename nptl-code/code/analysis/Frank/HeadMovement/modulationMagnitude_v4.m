function [ cVar, rawProjPoints ] = modulationMagnitude_v4( trlCodes, snippetMatrix, eventIdx, trlBaselineMatrix, ...
    ...
    for pIdx = 1:length(codeSets)
        ...
        setRates = triggeredAvg(snippetMatrix, eventIdx(setTrl), [movWindow(1), movWindow(end)]);
        ...
        for codeIdx=1:length(codeSets{pIdx})
            ...
            movWindowActivity = triggeredAvg(snippetMatrix, eventIdx(trlIdx), [movWindow(1), movWindow(end)]);
