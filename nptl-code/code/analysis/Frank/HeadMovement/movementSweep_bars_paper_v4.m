...
[ cVar, cVar_proj, rawProjPoints, dPCA_out ] = modulationMagnitude_v2( trlCodesReorder', smoothSnippetMatrix, eventIdx, baselineMatrix, movWindow, ...
...
for pIdx=1:length(movTypeText)
    ...
    standard_test = apply_dPCA_simple( smoothSnippetMatrix, eventIdx(trlIdx), ...
        mc, timeWindow/binMS, binMS/1000, {'CI','CD'}, 20, 'none' );
    
    ortho_test = apply_dPCA_simple( smoothSnippetMatrix, eventIdx(trlIdx), ...
        mc, timeWindow/binMS, binMS/1000, {'CI','CD'}, [3 3], 'xval', 'ortho' );
