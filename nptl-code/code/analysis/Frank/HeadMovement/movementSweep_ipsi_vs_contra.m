...
%     end
    ...
    %see movementTypes.m for code definitions
    armJoint = {'LeftSho','LeftRaise','LeftLower','LeftElbow','LeftWrist','LeftCloseHand','LeftOpenHand',...
...
imagesc(C);
set(gca,'XTick',1:length(allCodesRemap),'XTickLabel',horzcat(movLegends{:}),'XTickLabelRotation',45);
set(gca,'YTick',1:length(allCodesRemap),'YTickLabel',horzcat(movLegends{:}));
set(gca,'FontSize',14);
colorbar;
