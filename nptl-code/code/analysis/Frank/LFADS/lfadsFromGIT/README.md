...
<pre>
$ export PYTHONPATH=$PYTHONPATH:/Users/frankwillett/nptlBrainGateRig/code/analysis/Frank/LFADS/lfadsFromGIT
</pre>
...
--data_dir=/net/home/fwillett/Data \
--data_filename_stem=R_2016-02-02_1 \
--lfads_save_dir=/net/home/fwillett/lfadsRuns/Jenkins2016-02-02 \
--co_dim=0 \
--factors_dim=20 \
--ext_input_dim=0 \
...
###
python run_lfads.py --kind=train \
--data_dir=/home/fwillett/Data \
--data_filename_stem=R_2016-02-02_1 \
--lfads_save_dir=/home/fwillett/lfadsSaveDir/R_2016-02-02_1 \
--co_dim=0 \
--factors_dim=20 \
--ext_input_dim=0 \
--controller_input_lag=1 \
...
```
#nohup python run_lfads.py --kind=train --data_dir=/tmp/rnn_synth_data_v1.0/ --data_filename_stem=chaotic_rnn_no_inputs --lfads_save_dir=/tmp/lfads_chaotic_rnn_no_inputs --co_dim=0 --factors_dim=20 --ext_input_dim=0 --controller_input_lag=1 --output_dist=gaussian &
...
python run_lfads.py --kind=posterior_sample_and_average \
--data_dir=/tmp/rnn_synth_data_v1.0/ \
--data_filename_stem=chaotic_rnn_no_input \
--lfads_save_dir=/tmp/lfads_chaotic_rnn_no_input \
--co_dim=0 \
--factors_dim=20 \
--batch_size=1024 \
--ext_input_dim=0 \
...
python run_lfads.py --kind=posterior_sample_and_average \
--data_dir=/home/fwillett/rnn_synth_data_v1.0 \
--data_filename_stem=chaotic_rnn_no_inputs \
--lfads_save_dir=/home/fwillett/lfadsSaveDir/chaotic_rnn_no_inputs \
--co_dim=0 \
--factors_dim=20 \
--batch_size=1024 \
--ext_input_dim=0 \
