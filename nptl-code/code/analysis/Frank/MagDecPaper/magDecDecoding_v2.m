...
for s = 1:size(sessionList,1)
    for featureIdx = 1
        ...
        %%
        [ popResponse, sfResponse, fullModel, in, modelVectors, Q] =  fit4DimModel( saveDir, in );
        
        %%
        %save model for CL simulation
        neuralTuning = fullModel{1}.tuningCoef(2:end,:)';
        neuralCovariance = Q{1};
        
        save('/Users/frankwillett/Data/Derived/gruCLTest/neuralModel.mat','neuralTuning','neuralCovariance');
