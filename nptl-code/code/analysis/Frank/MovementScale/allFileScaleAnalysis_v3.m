datasets = {'JenkinsData','R_2018-01-18_1.mat';
    'JenkinsData','R_2018-01-019_1.mat'};
...
for d=1:length(datasets)
    ...
    R = load(['/Users/frankwillett/Data/Monk/JenkinsData/' datasets{d,2}]);
    R = R.R;
    for t=1:length(R)
        if ~isfield(R,'timeGoCue') || isempty(R(t).timeGoCue)
            R(t).timeGoCue = 21;
        end
    end
