datasets = {'t5.2018.01.24',{[6 7 8 9 10],[26 27 28]},{'IS','ISBCI'}};
        ...
        for blockSetIdx = 1:length(datasets{d,2})
            ...
            for innerSpeedCode=1:3
                ...
                dPCA_out = apply_dPCA_simple( alignDat.zScoreSpikes, alignDat.eventIdx(trlIdx(innerIdx)), ...
                    dirCodes(innerIdx), timeWindow/binMS, binMS/1000, {'CD','CI'} );
                close(gcf);
                ...
                oneFactor_dPCA_plot( dPCA_out,  (timeWindow(1)/binMS):(timeWindow(2)/binMS), ...
                    lineArgs, {'CD','CI'}, 'sameAxes', meanProfile');
                saveas(gcf,[outDir filesep datasets{d,3}{blockSetIdx} '_1fac_dPCA_' pfSet{alignSetIdx} '_sc' num2str(innerSpeedCode) '.png'],'png');
                saveas(gcf,[outDir filesep datasets{d,3}{blockSetIdx} '_1fac_dPCA_' pfSet{alignSetIdx} '_sc' num2str(innerSpeedCode) '.svg'],'svg');
            end
