function rnnDecMakeBatchScripts( scriptDir, outputDir, codeDir, ...
    ...
    for g=1:nGPU
        ...
        rnnDecMakeShellScriptSimple( [scriptDir 'gpu' num2str(availableGPU(g))], codeDir, paramStructs(runIdx), ...
    ...
    for g=1:nGPU
        newLine = ['\ntmux new-session -d -s rnnDec_tmux_gpu_' num2str(availableGPU(g)) ' ''sh ./gpu' num2str(availableGPU(g)) '.sh''']; 
        fprintf(fid, newLine);
    end
