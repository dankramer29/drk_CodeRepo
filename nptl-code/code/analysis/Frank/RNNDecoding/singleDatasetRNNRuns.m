%%
%raw features
remoteDatasetDir = '/net/home/fwillett/Data/Derived/rnnDecoding_2dDatasets/rawFeatures/Fold1';
remoteOutDir = '/net/home/fwillett/Data/Derived/rnnDecoding_2dDatasets_out/test2';
pyDir = '/net/home/fwillett/nptlBrainGateRig/code/analysis/Frank/BackpropSim/';
scriptDir = '/Users/frankwillett/Data/Derived/rnnDecoding_2dDatasets_scripts/test2/';
...
for nControlInput = 2:4
    remoteDatasetDir = ['/net/home/fwillett/Data/Derived/rnnDecoding_2dDatasets/4comp_' num2str(nControlInput) '/Fold1'];
    remoteOutDir = ['/net/home/fwillett/Data/Derived/rnnDecoding_2dDatasets_out/test_4comp_' num2str(nControlInput)];
    pyDir = '/net/home/fwillett/nptlBrainGateRig/code/analysis/Frank/BackpropSim/';
    scriptDir = ['/Users/frankwillett/Data/Derived/rnnDecoding_2dDatasets_scripts/test2_4comp_' num2str(nControlInput) '/'];
...
load([dataDir filesep 't5.2016.09.28.mat']);
...
%training meta
tm = load([paths.dataPath filesep 'Derived' filesep 'rnnDecoding_2dDatasets' filesep 'trainingMeta' filesep 't5.2016.09.28.mat'],'out');
...
prepDat = load([paths.dataPath filesep 'Derived' filesep 'rnnDecoding_2dDatasets' filesep 'rawFeatures' filesep 'Fold1' filesep 't5.2016.09.28.mat']);

%analyze results
outDir = '/Users/frankwillett/Data/Derived/rnnDecoding_2dDatasets_out/test2';
scriptDir = '/Users/frankwillett/Data/Derived/rnnDecoding_2dDatasets_scripts/test2/';
...
%load controls
controls = load([paths.dataPath filesep 'Derived' filesep 'rnnDecoding_2dDatasets' ...
    filesep 'controlDecoders' filesep 't5.2016.09.28.mat']);
