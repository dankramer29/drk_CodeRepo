function fittsModelDotPlots_zoomedAxes_v2( sessions, resultsDir, visModelType )
    ...
    for plotIdx=1:2
        ...
        if plotIdx==1
            limits = [2.5 3.5 5.5 1.0];
        else
            limits = [2 1.5 2.5 0.5];
        end
        ...
        for perfIdx=1:length(perfFields)
            ...
            text(0.05,0.90,['R2=' num2str(allR2(perfIdx,plotIdx),2)],...
                'Units','normalized');
