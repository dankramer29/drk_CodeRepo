bciSim is a set of functions for simulating, modeling and parameterizing steady-state velocity Kalman filters (i.e. linear velocity decoders with exponential smoothing). This folder contains the functions, example scripts, and an example dataset.
