function out = apply_pcaMarg_simple( features, eventIdx, trialCodes, timeWindow, timeStep, margNames, maxDim )
    %%
    ...
    %the following chunk of code formats the feature data into a 4 (single
