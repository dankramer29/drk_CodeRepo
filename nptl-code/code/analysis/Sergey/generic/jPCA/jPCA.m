...
[PCvectors,rawScores] = pca(smallA);  % SDS 2019: bringing up to date. econ is default
...
numPlanes = min( 2, floor( params.numPCs/2) ); % SDS: allows it to run on 2 PCs
for jPCplane = 1:numPlanes
...
%     rotV = princomp(testProj);
    rotV = pca(testProj); % SDS 2019: update to modern MATLAB
