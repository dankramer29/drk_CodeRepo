...
windowEarly = -500/20;   %ms before event onset / 20 ms per bin;
windowLate  = 2500/20;  % ms after event onset  / 20 ms per bin;
...
iti((iti < 17.5) & (iti >18.5)) = nan; % there's a new state in SF paradigm, 19,
