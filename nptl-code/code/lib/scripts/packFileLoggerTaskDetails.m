function fileLoggerFormat = packFileLoggerTaskDetails( taskName, versionID, varargin )
...
assert(formatIdx <=1400, 'Too many variables in format packet!');
formatFileName = uint8(zeros(1,20));
formatFileName(1:12) = 'task-details';
