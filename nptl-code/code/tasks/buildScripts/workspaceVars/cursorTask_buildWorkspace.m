function taskParamsStruct = cursorTask_buildWorkspace()
taskParamsStruct = createTunableStructure('cursorTaskSplit','taskParameters', 'taskParamsBus',...
    ...
    'multiclickColors', single([[255 24 29];[255 0 255]; [140 150 198]; [0 102 255]]./255)... %SNF multiclick- color the cursor turns for clicks 1-4
);
