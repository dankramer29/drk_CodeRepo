function taskParamsStruct = decisionTask_buildWorkspace()
taskParamsStruct = createTunableStructure('cursorTaskSplit','taskParameters', 'taskParamsBus',...
    ...
    'stopOffTarget',true, ...
    'stopOnClick',true, ...
    'outputType', cursorConstants.OUTPUT_TYPE_CURSOR,... %SF updated % not assigned to an output type, hopefully will be just ignored.  %     'outputType', uint16(cursorConstants.OUTPUT_TYPE_CURSOR),...
    ...
    'randomTaskBoundaries', single( [-.09 0.09; -0.09 0.09; -0.09 0.09; -0.09 0.09] ), ... % in random task cursorTask variant, targets can appear within these bounda
