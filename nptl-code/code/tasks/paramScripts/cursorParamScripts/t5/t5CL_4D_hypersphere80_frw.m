...
setModelParam('maxTaskTime',floor(1000*60*5)); % 15 minute max
...
%cap the speed at 2x the max speed set by beta, to make sure we don't get hosed by a
%giant noise burst
setModelParam('xkRawSpeedCap', (model.beta/1000)*2);
...
%%
% Exponetial gain?
setModelParam('powerGain', 2.33333    )
% setModelParam('powerGainUnityCrossing', 4.50e-05)
setModelParam('powerGainUnityCrossing', 5.746e-05)
