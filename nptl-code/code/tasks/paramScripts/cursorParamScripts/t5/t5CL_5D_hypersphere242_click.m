...
% %BJ: I don't think we need the "brittle" lines below now that we set 
% click threshold up above with "setHMMThreshold", right?
...
setModelParam('powerGainUnityCrossing', 0.0001) %SELF: 0.0002 makes 
% nonlinear gain *slower* during translation; might need to be 0.0001
