...
% task params
setModelParam('targetDiameter', 15);
setModelParam('cursorDiameter', 15);
...
nTargs = 5;
linePattern = linspace(-1,1,(nTargs*2)+1);
linePattern((nTargs+1)) = [];
fullPattern = 100*[zeros(1,(nTargs*2)); linePattern];
...
targetIndsMat(1:2,1:numTargetsInt)  = fullPattern;
