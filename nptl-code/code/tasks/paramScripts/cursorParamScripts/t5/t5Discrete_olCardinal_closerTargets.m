...
for centerIdx=1:size(centers,1)
    allTargets = [allTargets; repmat(centers(centerIdx,:), length(theta), 1)+160*[cos(theta)', sin(theta)']];
end
...
setModelParam('displayObject',uint8(cursorConstants.BACKGROUND_QUAD_CARDINAL_CLOSER));
