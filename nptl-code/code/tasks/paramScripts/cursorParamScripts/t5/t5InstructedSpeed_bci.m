...
setModelParam('targetDiameter', 180);
...
setModelParam('speedTaskMode',2);


% other params
setModelParam('randomSeed', 1);
setModelParam('useRandomDelay', 1);
setModelParam('expRandMu', 1250); %% this is the trial delay length parameter
...
setModelParam('delayPeriodGainScale', 0.25);
% zero gain at start
...
targetIndsMat(1:2,1:numTargetsInt)  = [ 409, -409; ...
                                        0,  0];
