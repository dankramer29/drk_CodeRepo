...
setModelParam('autoplayMovementDuration', uint16( 2500 ))   % Translation
...
setModelParam('autoplayRotationDuration', uint16( 2500 ))  % Rotation duration
...
%ensure that we uncap the speed
setModelParam('xkRawSpeedCap', 10000);
