...
% max task duration
setModelParam('maxTaskTime',1000*60*9); %SF: make it long enough to do 160 trials
...
setModelParam('targetDiameter', 115);
setModelParam('cursorDiameter', 45);
% other params
setModelParam('randomSeed', 1);
setModelParam('useRandomDelay', 1);
setModelParam('expRandMu', 750); %% this is the trial delay length parameter
setModelParam('expRandMin', 500);
setModelParam('expRandMax', 1300);
...
setModelParam('recenterDelay', 250); %snf debug 9.03
