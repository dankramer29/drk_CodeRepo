...
% task params
setModelParam('targetDiameter', 140);
...
setModelParam('inputType', uint32(cursorConstants.INPUT_TYPE_CURSOR_AND_HEAD));
...
targetIndsMat(1:4,1:numTargetsInt)  = [  0 409    0 -409   0 409    0 -409      0 409    0 -409    0 409    0 -409 
                                       409   0 -409    0   409   0 -409    0 409   0 -409    0  409   0 -409    0
                                         0   0    0    0   409  409  409  409 -409 -409 -409 -409 0  0    0    0
                                         409 409 409 409     0    0    0    0    0    0    0    0 -409 -409 -409 -409];
