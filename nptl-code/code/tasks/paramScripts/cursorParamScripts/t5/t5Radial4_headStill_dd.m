...
% Make cursor invisible uint16(zeros(3))
%setModelParam('cursorColors', uint16(ones(3))+200);
...
% Off diagonal
% targetIndsMat(1:2,1:numTargetsInt)  = [  289  -289  -289   289; ...
%                                          289   289  -289  -289];
