...
targetIndsMat(1:2,1:numTargetsInt/2)  = [  0 289 409  289    0 -289 -409 -289; ...
                                         409 289   0 -289 -409 -289    0 289];
 targetIndsMat(1:2,(numTargetsInt/2)+1:numTargetsInt)  =  [  0 289 409  289    0 -289 -409 -289; ...
                                                            409 289   0 -289 -409 -289    0 289]./2;
