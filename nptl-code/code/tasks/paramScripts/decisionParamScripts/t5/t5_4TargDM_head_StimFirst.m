...
%setModelParam('holdTime', 400); %prettttty sure I don't use a hold time-SF 06/18
setModelParam('stimDur', 500);
...
setModelParam('taskOrder', uint16(1)); % checkerboard first 
% viz: 
