...
whichMovementsTmp = uint8([...
    movementTypes.LEFT_SHO_SHRUG, ...
    movementTypes.LEFT_ARM_RAISE, ...
    movementTypes.LEFT_ELBOW_FLEX, ...
    movementTypes.LEFT_WRIST_EXT, ...
    movementTypes.LEFT_CLOSE_HAND, ...
    movementTypes.LEFT_OPEN_HAND, ...
    movementTypes.LEFT_INDEX_RAISE, ...
    movementTypes.LEFT_THUMB_UP, ...
    movementTypes.RIGHT_SHO_SHRUG, ...
    movementTypes.RIGHT_ARM_RAISE, ...
    movementTypes.RIGHT_ELBOW_FLEX, ...
    movementTypes.RIGHT_WRIST_EXT, ...
    movementTypes.RIGHT_CLOSE_HAND, ...
    movementTypes.RIGHT_OPEN_HAND, ...
    movementTypes.RIGHT_INDEX_RAISE, ...
    movementTypes.RIGHT_THUMB_UP, ...
]);
