...
whichMovementsTmp = uint8([...
    movementTypes.RIGHT_ARM_UP, ...
    movementTypes.RIGHT_ARM_DOWN, ...
    movementTypes.RIGHT_ARM_RIGHT, ...
    movementTypes.RIGHT_ARM_LEFT, ...
    movementTypes.RIGHT_ARM_IN, ...
    movementTypes.RIGHT_ARM_OUT, ...
    movementTypes.LEFT_ARM_UP, ...
    movementTypes.LEFT_ARM_DOWN, ...
    movementTypes.LEFT_ARM_RIGHT, ...
    movementTypes.LEFT_ARM_LEFT, ...
    movementTypes.LEFT_ARM_IN, ...
    movementTypes.LEFT_ARM_OUT, ...
]);
