...
whichMovementsTmp = uint8([...
    movementTypes.LEFT_ANKLE_UP, ...
    movementTypes.LEFT_ANKLE_DOWN, ...
    movementTypes.LEFT_KNEE_EXTEND, ...
    movementTypes.LEFT_LEG_UP, ...
    movementTypes.LEFT_TOE_CURL, ...
    movementTypes.LEFT_TOE_OPEN, ...
    movementTypes.RIGHT_ANKLE_UP, ...
    movementTypes.RIGHT_ANKLE_DOWN, ...
    movementTypes.RIGHT_KNEE_EXTEND, ...
    movementTypes.RIGHT_LEG_UP, ...
    movementTypes.RIGHT_TOE_CURL, ...
    movementTypes.RIGHT_TOE_OPEN, ...
]);
