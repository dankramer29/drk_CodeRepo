...
whichMovementsTmp = uint8([...
    movementTypes.TURN_HEAD_RIGHT, ...
    movementTypes.TURN_HEAD_LEFT, ...
    movementTypes.TURN_HEAD_UP, ...
    movementTypes.TURN_HEAD_DOWN, ...
    movementTypes.HEAD_TILT_RIGHT, ...
    movementTypes.HEAD_TILT_LEFT, ...
    movementTypes.HEAD_FORWARD, ...
    movementTypes.HEAD_BACKWARD, ...
]);
