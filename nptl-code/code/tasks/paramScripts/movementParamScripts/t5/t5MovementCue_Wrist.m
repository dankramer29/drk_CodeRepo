...
% periods.
%
% This particular script is used for the wrist-related set of the cued
% movement task.
...
whichMovementsTmp = uint8([...
    ...
    movementTypes.WRIST_ULNAR_DEVIATE, ...
    movementTypes.WRIST_RADIAL_DEVIATE, ...
    movementTypes.WRIST_PRONATE, ...
    movementTypes.WRIST_SUPINATE, ...
]);
