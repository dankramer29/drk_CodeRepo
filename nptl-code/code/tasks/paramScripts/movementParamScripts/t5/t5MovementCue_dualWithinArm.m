...
whichMovementsTmp = uint8([...
    movementTypes.SHO_SHRUG, ...
    movementTypes.ELBOW_FLEX, ...
    movementTypes.WRIST_EXT, ...
    movementTypes.CLOSE_HAND, ...
    movementTypes.SHRUG_AND_ELBOW, ...
    movementTypes.SHRUG_AND_WRIST, ...
    movementTypes.SHRUG_AND_HAND, ...
    movementTypes.ELBOW_AND_WRIST, ...
    movementTypes.ELBOW_AND_HAND, ...
    movementTypes.WRIST_AND_HAND, ...
]);
