...
setModelParam('targetDiameter', 220);
...
setModelParam('symbolGetReadyTime', uint32(20000));
setModelParam('symbolMoveTimeTwo', uint32(60000));
% setModelParam('symbolMoveTimeOne', uint32(6000));
% setModelParam('symbolRehearseTime', uint32(24000));
% setModelParam('symbolGetReadyTime', uint32(2000));
% setModelParam('symbolMoveTimeTwo', uint32(6000));
