...
% 
% INPUT: 
%        arrayName  string specifying which array. Currently supports
%                   'T5_lateral', 'T5_medial'
%
% OUTPUT:
...
%
% Created by Sergey Stavisky on 3 January 2011 (originally arrayMap.m for rigC)
% Updated 17 December 2017 with human arrays instead of monkey arrays.
% T5 map arranged by Sharlene Flesher in Decemeber 2017 based on BlackRock excel files.
%
% IMPORTANT NOTES:
% T5 anatomyRotate and anatomyTranslate are with respect to the t5 arrays-in-brain reconsutrction 
% as found in Even-Chen et al. TBME 2017. 
function [emap, anatomyRotate, anatomyTranslate] = arrayMapHumans( arrayName )
    switch arrayName
        case 'T5_medial'   % T5's Medial (Posterior) array, implanted 2016, Array No 4383001661
        ...
        case 'T5_lateral' %  T5's Lateral (Anterior) array, implanted 2016, Array 4383001654
            emap = [ 0	2	1	3	4	6	8	10	14	0 ;
                     65	66	33	34	7	9	11	12	16	18 ;
                     67	68	35	36	5	17	13	23	20	22 ;
                     69	70	37	38	48	15	19	25	27	24 ; %:. 
        ...
        case 'T8_lateral'
            ...
            % RELATIVE ARRAY POSITIONS
            % I have 95% confidence in these based on the Lancet 2017 paper supplement, but 
            % there's a tiny chance that the right side of panel A is flipped wrt the left side,
            % in which case everything would have to be reflected across the vertical axis (fliplr).
