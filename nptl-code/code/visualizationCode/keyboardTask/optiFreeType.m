function q = optiFreeType()

	q.keyboardType = uint8(keyboardConstants.KEYBOARD_OPTIFREE);
    ...
    trStartX = 0;
    trStartY = 0.0001;
    trHeight = buttonHeight*0.95;
    q.textRegion = [trStartX trStartY trStartX+(totalWidth)*6 trStartY+trHeight];
    ...
    darkergrey = darkgrey*0.6;
    q.textRegBgColor = darkergrey;
