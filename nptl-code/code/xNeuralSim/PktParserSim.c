...
#define S_FUNCTION_NAME PktParserSim
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      sendConfigPkts
...
/* Output Port  1 */
#define OUT_PORT_1_NAME      responsePktData
#define OUTPUT_1_WIDTH       1024
...
/* Output Port  2 */
#define OUT_PORT_2_NAME      responsePktSize
...
/* Output Port  3 */
#define OUT_PORT_3_NAME      setRunlevelPktData
#define OUTPUT_3_WIDTH       1024
...
/* Output Port  4 */
#define OUT_PORT_4_NAME      setRunlevelPktSize
...
/* Output Port  5 */
#define OUT_PORT_5_NAME      running
...
extern void PktParserSim_Outputs_wrapper(const uint32_T *clk,
                          const uint8_T *data,
                          const real_T *size,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T   *size  = (const real_T*) ssGetInputPortSignal(S,2);
    uint8_T        *sendConfigPkts  = (uint8_T *)ssGetOutputPortRealSignal(S,0);
    uint8_T        *responsePktData  = (uint8_T *)ssGetOutputPortRealSignal(S,1);
    real_T        *responsePktSize  = (real_T *)ssGetOutputPortRealSignal(S,2);
    uint8_T        *setRunlevelPktData  = (uint8_T *)ssGetOutputPortRealSignal(S,3);
    real_T        *setRunlevelPktSize  = (real_T *)ssGetOutputPortRealSignal(S,4);
    int32_T        *running  = (int32_T *)ssGetOutputPortRealSignal(S,5);

    PktParserSim_Outputs_wrapper(clk, data, size, sendConfigPkts, responsePktData, responsePktSize, setRunlevelPktData, setRunlevelPktSize, running);
}
