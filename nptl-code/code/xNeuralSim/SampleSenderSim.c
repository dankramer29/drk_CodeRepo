 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Fri Sep 27 14:00:26 2013
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SampleSenderSim
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          6
/* Input Port  0 */
#define IN_PORT_0_NAME      clk
...
/* Input Port  1 */
#define IN_PORT_1_NAME      sampleData
#define INPUT_1_WIDTH       96*15
...
/* Input Port  2 */
#define IN_PORT_2_NAME      sampleNum
...
/* Input Port  3 */
#define IN_PORT_3_NAME      numSamples
...
/* Input Port  5 */
#define IN_PORT_5_NAME      maxNumCbPkts
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      udpData
...
/* Output Port  1 */
#define OUT_PORT_1_NAME      udpSize
...
extern void SampleSenderSim_Outputs_wrapper(const uint32_T *clk,
...
{
    const uint32_T   *clk  = (const uint32_T*) ssGetInputPortSignal(S,0);
    const int16_T   *sampleData  = (const int16_T*) ssGetInputPortSignal(S,1);
    const int32_T   *sampleNum  = (const int32_T*) ssGetInputPortSignal(S,2);
    const int32_T   *numSamples  = (const int32_T*) ssGetInputPortSignal(S,3);
    const int32_T   *running  = (const int32_T*) ssGetInputPortSignal(S,4);
    const int32_T   *maxNumCbPkts  = (const int32_T*) ssGetInputPortSignal(S,5);
    uint8_T        *udpData  = (uint8_T *)ssGetOutputPortRealSignal(S,0);
    real_T        *udpSize  = (real_T *)ssGetOutputPortRealSignal(S,1);
    uint32_T        *cbPkts  = (uint32_T *)ssGetOutputPortRealSignal(S,2);

    SampleSenderSim_Outputs_wrapper(clk, sampleData, sampleNum, numSamples, running, maxNumCbPkts, udpData, udpSize, cbPkts);
}
