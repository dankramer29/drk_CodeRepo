...
#define S_FUNCTION_NAME SampleSenderSimNSP2
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void SampleSenderSimNSP2_Outputs_wrapper(const uint32_T *clk,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    SampleSenderSimNSP2_Outputs_wrapper(clk, sampleData, sampleNum, numSamples, running, maxNumCbPkts, udpData, udpSize, cbPkts);
}
