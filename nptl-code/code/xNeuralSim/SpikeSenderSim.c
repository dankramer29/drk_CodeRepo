...
#define S_FUNCTION_NAME SpikeSenderSim
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void SpikeSenderSim_Outputs_wrapper(const uint32_T *clk,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    SpikeSenderSim_Outputs_wrapper(clk, spikeCounts, chanNum, numChans, running, udpData, udpSize, cbPkts);
}
