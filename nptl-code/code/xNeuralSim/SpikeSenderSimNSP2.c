 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Fri Aug  9 18:27:37 2013
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SpikeSenderSimNSP2
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Input Port  1 */
#define IN_PORT_1_NAME      spikeCounts
#define INPUT_1_WIDTH       96
...
/* Input Port  3 */
#define IN_PORT_3_NAME      numChans
...
extern void SpikeSenderSimNSP2_Outputs_wrapper(const uint32_T *clk,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const int32_T   *spikeCounts  = (const int32_T*) ssGetInputPortSignal(S,1);
    const int32_T   *chanNum  = (const int32_T*) ssGetInputPortSignal(S,2);
    const int32_T   *numChans  = (const int32_T*) ssGetInputPortSignal(S,3);
    ...
    SpikeSenderSimNSP2_Outputs_wrapper(clk, spikeCounts, chanNum, numChans, running, udpData, udpSize, cbPkts);
}
